    ...
    const variantType = {
      default: {
        className: cn(
          ...
          "placeholder:text-primary/40 selection:bg-primary/40 selection:text-background-secondary",
          "focus-visible:border-ring focus-visible:ring-[1px] focus-visible:ring-muted/50",
